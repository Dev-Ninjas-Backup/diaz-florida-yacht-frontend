...
const DockSideBlog = () => {
  return (
    <CustomContainer>
      <div className="my-10 md:my-20 space-y-5 md:space-y-10">
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
          ...
          <div className="flex items-center gap-3 lg:ml-6">
            <button className="bg-secondary text-white px-3 md:px-6 py-2 md:py-3 rounded-xl hover:bg-blue-700 transition-colors font-medium">
              Read All
            </button>
          </div>
        </div>
